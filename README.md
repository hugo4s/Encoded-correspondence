![image](https://github.com/hugo4s/coded_correspondence_python/assets/140451515/1e4580d0-caa6-454f-b8e3-430bba76d783)
...
Contribuições para melhorar ou expandir este projeto são bem-vindas! Sinta-se à vontade para abrir problemas (issues) ou enviar solicitações de recebimento (pull requests) com suas sugestões.

## Autor

Este projeto foi realizado por [Seu Nome] como parte de um exercício de programação em Python.
